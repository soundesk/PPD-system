...
import { User, Home, Flower2, Sparkles } from 'lucide-react';
import MomIcon from "../assets/Group 1.svg";
        ...
        <div className="flex items-center justify-between py-4">
          ...
          >
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-pink-200/30 rounded-full blur-md group-hover:bg-pink-300/40 transition-all" />
                 <div className="relative bg-gradient-to-br from-pink-100 to-purple-100 p-2 rounded-full border border-pink-300/50 backdrop-blur-sm group-hover:border-pink-400/60 transition-all flex items-center justify-center">
                  <img 
      src={MomIcon} 
      alt="Logo Icon" 
      className="w-7 h-7 pink-500"
    />
  </div>
</div>
