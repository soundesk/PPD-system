...
export function Results({ score, onReset }: ResultsProps) {
  ...
  const resources = [
    ...
    },
    {
      ...
      desc: 'Schedule an appointment to discuss your symptoms',
      urgent: false
    },
    {
      icon: FileText,
      title: 'Support Groups',
      desc: 'Connect with other mothers experiencing similar challenges',
      urgent: false
    }
  ];
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {resources.map((resource, index) => (
                ...
                >
                  <Card className={`p-6 ${resource.urgent ? 'bg-rose-50 border-rose-300' : 'bg-white/80'} backdrop-blur-sm hover:shadow-lg transition-all duration-300`}>
